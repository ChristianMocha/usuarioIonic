...
let AppComponent = class AppComponent {
    constructor(platform, usuarioService, router) {
        this.router = router;
        platform.ready().then(() => {
...
/* harmony import */ var _awesome_cordova_plugins_native_storage_ngx__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @awesome-cordova-plugins/native-storage/ngx */ 5916);
...
AppModule = (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_4__.NgModule)({
        ...
        providers: [_awesome_cordova_plugins_native_storage_ngx__WEBPACK_IMPORTED_MODULE_2__.NativeStorage, { provide: _angular_router__WEBPACK_IMPORTED_MODULE_8__.RouteReuseStrategy, useClass: _ionic_angular__WEBPACK_IMPORTED_MODULE_6__.IonicRouteStrategy }],
...
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @ionic/angular */ 3819);
/* harmony import */ var _awesome_cordova_plugins_native_storage_ngx__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @awesome-cordova-plugins/native-storage/ngx */ 5916);
...
let UsuarioService = class UsuarioService {
    constructor(http, storage, platform) {
        ...
        this.urlUser = 'https://jsonplaceholder.typicode.com/users';
        this.urlImg = 'https://i.pravatar.cc/150?';
        this.usuarios = [];
    }
    getUser() {
        return new Promise((resolve, reject) => (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__awaiter)(this, void 0, void 0, function* () {
            yield this.http.get(this.urlUser).subscribe((res) => {
                let i = 1;
                if (res.length > 0) {
                    res.forEach(resOne => {
    ...
    saveStorage(user) {
        return new Promise((resolve, reject) => {
            if (this.platform.is('cordova')) {
                this.storage.setItem('user', JSON.stringify((user))).then(() => resolve(true), error => resolve(false));
            }
            else {
    ...
    deleteStorage() {
        return new Promise((resolve, reject) => {
            if (this.platform.is('cordova')) {
                this.storage.remove('user').then(() => resolve(true), error => resolve(false));
            }
            else {
